...
<div class="relative flex min-h-screen flex-col justify-center overflow-hidden bg-black py-6 sm:py-12">
  <div class="relative flex flex-col items-center gap-2 max-w-xl p-6 mx-auto rounded-lg w-full">
    ...
    <h2 class='text-neutral-400 text-lg text-center'>by Darkmaterial</h2>
    <span class='text-neutral-400 mt-8'>Ваше пространство для развлечения</span>
    <div class='h-16' />
  </div>
  <div class='w-full grid grid-cols-2 gap-2'>
    <div class='relative w-full h-48 p-4 hover:bg-neutral-950 flex flex-col items-center justify-center gap-4 rounded-md border border-neutral-900 hover:border-white transition-colors'>
      ...
      <div class='w-fit h-fit flex items-center justify-center gap-2 flex-col'>
        ...
        <span class='text-xs text-neutral-400 text-center'>Место, где живет <br /> разработка и дизайн</span>
      </div>
    </div>
    <div class='relative w-full h-48 p-4 hover:bg-neutral-950 flex flex-col items-center justify-center gap-4 rounded-md border border-neutral-900 hover:border-white transition-colors'>
      <a class='absolute w-full h-full' href="https://frame.darkmaterial.space" target="_blank"></a>
      <img src="${domain}/frame-dark.svg" width="48" height="48" />
      <div class='w-fit h-fit flex items-center justify-center gap-2 flex-col'>
        <span class='text-white font-semibold text-center'>Frame</span>
        <span class='text-xs text-neutral-400 text-center'>Создавайте и публикуйте <br /> свои работы у нас</span>
      </div>
    </div>
  </div>
</div>`;
